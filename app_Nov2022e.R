...
ui <- bootstrapPage(
  ...
  bsModal("show3dStuff", title = "Genetic diversity surface", trigger = "show3d", size = "large", plotlyOutput("plotyplot", width = "100%"))
)
                   ...
                   session)
{
  ...
  output$plotyplot <- renderPlotly({
    ...
    if (!is.null(click))
    {
      #show_modal_spinner(spin = "flower", text = "Computing 3D Surface Representation", color = "#FF6347")
